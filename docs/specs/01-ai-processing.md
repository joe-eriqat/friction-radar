...
- Default model `openai/gpt-5.4` at `temperature=0` (Connector's concern; see spec 02). The
  relevance judgment is model-sensitive — `gpt-5.4` and `gpt-4o` both score P=0.91/R=1.00 on the
  labelled eval vs `gpt-4o-mini`'s P=0.77/R=0.48; `gpt-4o-mini` remains a cheaper option. Eval
  harness: `scripts/eval_relevance.py`.
